      ...
      {!spotify && (
        <>
          ...
          <div className="flex flex-col items-center justify-center gap-0 py-6">
            ...
            <div>
              <a
                href="https://secure6.store.apple.com/ca/shop/signIn?ssi=1AAABkfRMdZUg3lzvubplDaQRpqjE2enayblgBQUtxggSbGmJnaUuATUAAAA3aHR0cHM6Ly93d3cuYXBwbGUuY29tL2NhL3Nob3Avc29ycnkvaWxsZWdhbF9hcmd1bWVudHN8fAACAQT8nIMk8PjmUm2AYxiG4zxBJzw1Bo2BKDiCzlIaGP2n"
                target="_blank"
              >
                <Image
